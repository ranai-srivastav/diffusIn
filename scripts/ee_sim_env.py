"""
Modified version of the ee_sim_env.py in act repo
"""
...
from utils import sample_box_pose, sample_insertion_pose, get_insertion_pose
...
class InsertionEETask(BimanualViperXEETask):
    ...
    def initialize_episode(self, physics):
        ...
        peg_pose, socket_pose = get_insertion_pose()
