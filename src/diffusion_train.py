...
train_dataloader, val_dataloader, norm_dataset_stats, is_sim = load_data(DATASET_PATH, NUM_EPISODES, "top", BATCH_SIZE, 1)
    ...
    for epoch_idx in t_global:
        ...
        with tqdm(train_dataloader, desc='Batch', leave=False) as t_epoch:
            for nbatch in t_epoch:
                ...
                noise = torch.randn(naction.shape, device=DEVICE)       #NOTE: Should this be uniform? Or Gaussian?
